...
import com.liuweiwei.biz.ClaimVoucherBiz;
import com.liuweiwei.dao.ClaimVoucherDao;
import com.liuweiwei.dao.ClaimVoucherItemDao;
import com.liuweiwei.dao.DealRecordDao;
...
public class ClaimVoucherBizImpl implements ClaimVoucherBiz {
    ...
    private static ClaimVoucherDao claimVoucherDao;
    private static ClaimVoucherItemDao claimVoucherItemDao;
    private static DealRecordDao dealRecordDao;
    private static EmployeeDao employeeDao;
    static {
        ctx1 = new ClassPathXmlApplicationContext("classpath:spring-dao.xml");
        claimVoucherDao = ctx1.getBean(ClaimVoucherDao.class);
        claimVoucherItemDao = ctx1.getBean(ClaimVoucherItemDao.class);
        dealRecordDao = ctx1.getBean(DealRecordDao.class);
